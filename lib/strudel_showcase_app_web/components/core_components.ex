defmodule StrudelShowcaseAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StrudelShowcaseAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StrudelShowcaseAppWeb.Gettext, "errors", msg, opts)
    end
  end
